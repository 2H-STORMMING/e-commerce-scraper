  ...
  return (
    ...
    >
      ...
      <div className="w-full md:max-w-2xl">
        ...
        >
          <div className="flex items-center gap-2 w-full px-4 ">
            <div
              className="flex items-center space-x-2 bg-white shadow-xl rounded-full
            border-0 px-6 py-4 md:max-w-5xl flex-1"
            >
          ...
          <div
            className="grid grid-cols-2 gap-2 p-4 md:grid-cols-4 maxx--w-lg 
      ...
      <div className=" hidden lg:flex flex-1 justify-end">
        {/*  Avatar */}
        <Avatar name="HAMZA HADRI" round size="58" />
      </div>
    </header>
  );
}
